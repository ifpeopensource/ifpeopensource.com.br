  ...
  return (
    ...
    >
      ...
      <ModalText>
        ...
        tecnologia e cooperação, assim existe Open Source.
      </ModalText>
      ...
      <ModalText>
        ...
        Android é baseado em Linux. Também pode se dizer que o Linux também
        “roda a internet”, já que a esmagadora maioria dos servidores que
        hospedam nossos sites e aplicativos usam Linux. Esta breve história é só
        um dos incríveis casos de sucesso que também acontecem com diversas
        outras comunidades que também são apoiadas por empresas como Google,
      ...
      <ModalText>
        ...
        comunidade de alunos do IFPE têm de{' '}
        <Bold>
        ...
        que uma comunidade deste tipo pode proporcionar.
      </ModalText>
